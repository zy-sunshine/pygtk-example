...
from jbrout.commongtk import Buffer
...
class ListView(ThumbnailsView):
    ...
    def get_thumb(self,idx):
        ...
        return self.items[idx].getThumb()
        node = self.items[idx]
...
class Items:
    def __init__(self, image_file):
        ...
        #self.display = image_file.display
        self.display = "display"
    def getThumb(self):
        pixmap = gtk.gdk.pixbuf_new_from_file(self.file)
        return pixmap
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        ...
        path_base = '/home/oldhome/Pictures/Photos'
